...
passport.use(new GoogleStrategy({
    ...
    callbackURL: "https://secret-island-28566.herokuapp.com/auth/google/donate",
...
const auth = {
  auth: {
    api_key: 'bd3c27d54a5089ef8cd137c78473c3f3-4b1aa784-3b02d902',
    domain: 'sandbox261484bf067444e2a318a6436b356ed3.mailgun.org'
  }
};
...
const sendMail = function(email, subject, text, cb){
  const mailOptions = {
    from: email,
    to: 'shetty.pooja18@siesgst.ac.in',
    subject: subject,
    text: text
  };
